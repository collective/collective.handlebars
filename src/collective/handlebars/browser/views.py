...
class HandlebarMixin:
    ...
    def _get_partial_key(self, partial_filename):
        """
        :param partial_filename: full path of partial (/home/vagrant/templates/_slideshow.js.hbs
    ...
    def _get_hbs_template(self, hbs_filename):
        """
        :param hbs_filename: full path of partial (/home/vagrant/templates/_slideshow.js.hbs
...
class HandlebarsBrowserView(BrowserView, HandlebarMixin):
    """ A simple browserview using handlenbars as templating engine"""
...
class HandlebarsPloneView(BrowserView, HandlebarMixin):
    """ A handlebars view rendered in the content slot of the main template of Plone
    """

    main_template = ViewPageTemplateFile('templates/plone_standard_template.pt')
